```CMD.EXE
MKDIR D:\WORK\centos9
PUSHD D:\WORK\centos9 & REM PUSHD なら一挙に移動できる
vagrant -v & REM Vagrant 2.2.19 など
vagrant box add boxomatic/centos-stream-9 & REM ./work.CentOS9Stream.md
vagrant box list & REM boxomatic/centos-stream-9 (virtualbox, 20220501.0.1)
MKDIR share
vagrant init boxomatic/centos-stream-9
git init
...
git add Vagrantfile
git commit -m "vagrant init. , boxomatic/centos-stream-9."
REM edit
git diff
